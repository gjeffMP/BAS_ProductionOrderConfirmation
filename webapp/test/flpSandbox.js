		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commpmaterialsprodorderconfirmation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commpmaterialsprodorderconfirmation-display": {
								"semanticObject": "commpmaterialsprodorderconfirmation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mpmaterials.prodorderconfirmation",
									"url": sap.ui.require.toUrl("com/mpmaterials/prodorderconfirmation")
								}
							}
						}
					}
